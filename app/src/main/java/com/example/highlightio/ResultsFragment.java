...
public class ResultsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflated = inflater.inflate(R.layout.fragment_results, container, false);

        listView = inflated.findViewById(R.id.list);
        matches = new ArrayList<Match>();
        progress = inflated.findViewById(R.id.progress);
        spinner = inflated.findViewById(R.id.query);
        team = inflated.findViewById(R.id.team);
        tourn = inflated.findViewById(R.id.tour);
        search = inflated.findViewById(R.id.search);
        emptyView = inflated.findViewById(R.id.empty_view);
        preferences = getActivity().getPreferences(Context.MODE_PRIVATE);



        // Inflate the layout for this fragment
        ArrayAdapter<CharSequence> spinAdapter = ArrayAdapter.createFromResource(getContext(), R.array.quantity, android.R.layout.simple_spinner_item);
        ...
        adapter = new MatchAdapter(getContext(), R.layout.list_item, matches);
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            ResultsFragmentDirections.ActionResultsFragmentToDetailsFragment action = ResultsFragmentDirections.actionResultsFragmentToDetailsFragment(clicked);
